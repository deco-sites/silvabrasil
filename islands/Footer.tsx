    ...
    <div class="relative w-full text-sm text-slate  rounded-t-[20px]">
      ...
      <div class="py-12 px-6 lg:px-16">
        <div class="w-full flex flex-col items-start mb-16 lg:mb-0">
          ...
          <div class="w-full flex flex-col items-center text-center">
            ...
            <div class="flex flex-col items-center">
              <span
                class="mb-12 text-2xl lg:text-4xl font-bold font-serif lg:hidden" 
                dangerouslySetInnerHTML={{
                  __html: textContent[languageSwitcher.value].footerSection.sloganMobile
                }}
              />
              <span
                class="hidden lg:flex mb-12 text-2xl font-serif"
                dangerouslySetInnerHTML={{
                  __html: textContent[languageSwitcher.value].footerSection.slogan
                }}
              />
            </div>
          </div>
          <div class="w-full flex flex-col lg:flex-row lg:justify-between xl:justify-evenly container">
            <div class="lg:w-[310px] flex flex-col">
              <span
                class="mb-9 text-xl font-sans text-start"
                dangerouslySetInnerHTML={{
                  __html: textContent[languageSwitcher.value].footerSection.text
                }}
              />
              <p class="hidden lg:inline-block font-regular text-slate text-sm">
                {textContent[languageSwitcher.value].footerSection.copyright}
              </p>
            </div>
            ...
            <div class="flex flex-col md:flex-row gap-11">
              <div class="mb-9">
                <h4 class="text-2xl lg:text-xl font-regular mb-4">
                  {textContent[languageSwitcher.value].footerSection.enterpriseMenuTitle}
                </h4>
              ...
              <div class="mb-9">
                <h4 class="text-2xl lg:text-xl font-regular mb-4">
                  {textContent[languageSwitcher.value].footerSection.customerServiceTitle}
                </h4>
                <div class="flex flex-col">
                  <a
                    target="_blank"
                    href="https://wa.me/551930610061?text=Olá%2C%20vim%20do%20site%20da%20Silva%20e%20quero%20falar%20com%20vocês."
              ...
              <div class="mb-9">
                <h4 class="text-2xl lg:text-xl font-regular mb-4">
                  {textContent[languageSwitcher.value].footerSection.socialMedia}
                </h4>
        ...
        <div class="items-start flex lg:hidden">
          <p class="font-regular text-slate text-sm">
            {textContent[languageSwitcher.value].footerSection.copyright}
          </p>
        </div>
      </div>
