...
export default function TalkWithUsSection({
  ...
  return (
    ...
    >
      <div class="w-full h-auto lg:w-2/3 lg:px-20 pt-9 lg:pt-0 lg:py-24 bg-green-900 lg:rounded-xl px-6 mb-9 lg:mb-0">
        <div class="h-full justify-between flex flex-col items-start text-left">
          <div class="mb-6 lg:max-w-[407px]">
            <h2 class="text-4xl lg:text-5xl font-bold text-slate mb-2 font-serif">
              {title}
            </h2>
          ...
          <a
            ...
            class="inline-flex items-center justify-center font-bold text-base bg-green-500 text-white py-3 px-6 lg:px-0 rounded-lg transform transition duration-400 hover:scale-105"
          >
      ...
      <div class="w-full h-auto lg:w-1/3 lg:rounded-xl px-6 lg:px-20 pb-12 lg:pb-0 lg:py-24">
        {form && (
